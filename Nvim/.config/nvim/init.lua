...
if vim.g.vscode then
    ...
    if has_lspzero then
        ...
        lspzero.on_attach(function(client, bufnr)
            ...
            keymap("n", "<leader>vR", vim.lsp.buf.rename, { desc = "Rename", buffer = bufnr, remap = false })
            keymap("n", "<leader>vf", vim.lsp.buf.format, {
                desc = "Format",
                buffer = bufnr,
                remap = false,
            })
    ...
    if has_telescope_builtin then
        ...
        keymap("n", "<leader>f", telescope_builtin.find_files, { desc = "Find Files" })
