...
;; accept. For example:
;;
(setq doom-font (font-spec :family "Iosevka Nerd Font Regular" :size 20)
      doom-variable-pitch-font (font-spec :family "Iosevka Nerd Font Regular" :size 20)
      doom-big-font (font-spec :family "Iosveka Nerd Font Regular" :size 32))
;;
