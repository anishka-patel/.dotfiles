...
(custom-set-variables
 ...
 '(package-selected-packages
   '(lua-mode hl-todo toggle-term format-all evil-surround auto-package-update dired-hide-dotfiles dired-open all-the-icons-dired dired-single lsp-ivy lsp-ui company-box company lsp-mode evil-collection evil general counsel ivy-rich which-key rainbow-delimiters doom-modeline ivy command-log-mode)))
(custom-set-faces
